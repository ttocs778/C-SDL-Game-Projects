...
{
	PlayerMove* playerMove = mGame->GetPlayer()->GetComponent<PlayerMove>();

	return playerMove->GetVel();
}
...
{
	CameraComponent* cameraPlayer = mGame->GetPlayer()->GetComponent<CameraComponent>();
	return cameraPlayer->GetPitchAngle();
}
